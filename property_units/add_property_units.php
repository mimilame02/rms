                  ...
                  <div class="col-md-12">
                    <div class="form-group-row">
                      <div class="p-2">
                        ...
                        <input type="number" class="form-control form-control-sm" id="one_month_deposit" placeholder="enter amount" name="one_month_deposit">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group-row">
                      <div class="p-2">
                        ...
                        <input type="number" class="form-control form-control-sm" id="one_month_advance" placeholder="enter amount" name="one_month_advance">
                      </div>
                    </div>
                  </div>
                </div>
