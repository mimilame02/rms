                        ...
                        <div class="col d-flex">
                          <div class="col-lg-12">
                            <p>Check box if features are allowed:</p>
                              ...
                              $selected_features = isset($tenant_obj->features) ? json_decode($tenant_obj->features) : array();
                  ...
                  <div class="row g-3">
                    <h4 class="card-title fw-bolder">Image Details</h4>
                      <div class="pt-4">
                        ...
                        <div class="image-container float-right pb-3" style="display: none;">
                          <img id="uploaded-image" src="default-image.jpg" alt="Default Image" height="250px" width="250px">
                        </div>
    ...
    $(document).ready(function() {
      $('#image_path').on('change', function() {
        ...
        if (input.files && input.files[0]) {
          ...
          $('#image_path').removeClass('col-md-6');
