                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 align-items-center justify-content-start">
                        ...
                        <div class="ms-3 d-flex align-items-center justify-content-end col-md-10 float-right">
                          ...
                          <input type="date" id="payment_date" class="form-control form-control-sm" name="payment_date" value="<?php echo ".$payment_date;" ?>" required>
                          <button type="button" class="btn btn-outline-secondary form-control-sm btn-secondary text-dark" onclick="setToday()">Today</button>
                        </div>
                      </div>
                    </div>
                  </div>
...
function calculateBalance() {
  ...
  if (useAdvance) {
    ...
    balance = amountPaid - (rent + electricity + water);
  }
