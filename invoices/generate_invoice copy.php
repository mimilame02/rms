                    ...
                    <div class="d-flex g-3">
                      <select name="penalty" id="penalty" class="form-select form-control col-md-6" onchange="updatePenalty()">
                        ...
                        <?php foreach ($penalty_data as $penalties): ?>
                          <option value="<?php echo $penalties['id']; ?>" data-penalty_percent="<?php echo $penalties['percentage']; ?>" data-description="<?php echo $penalties['description']; ?>"><?php echo $penalties['percentage'] * 100 . "%"; ?></option>
                        <?php endforeach; ?> 
                      </select> 
...
function calculateTotal() {
    ...
    const penaltyAmount = parseFloat(selectedPenalty.getAttribute('data-penalty_percent')) || 0;
