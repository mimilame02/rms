                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      <div class="form-group-row">
                        ...
                        <input class="form-control form-control-sm req" type="text" id="property_name" name="property_name" required oninput="updateValidation(this)" onkeyup="this.value = this.value.replace(/\b\w/g, function(l){ return l.toUpperCase(); })">   
                      ...
                      <div class="form-group-row">
                        <div class="col-md-6">
                            ...
                            <select class="form-control form-control-sm mb-3 req" id="landlord" name="landlord" required oninput="updateValidation(this)">
                              <option class="col-md-6" value="none">Select Landlord</option>
                                <?php
                      ...
                      <div class="col-md-6">
                        <div class="form-group-row">
                          <div class="">
                            ...
                            <input class="form-control form-control-sm req" type="number" id="num_of_floors" name="num_of_floors" min="1" max="100" required onchange="generateFloorPlan()" oninput="updateValidation(this)" <?php if(isset($_POST['num_of_floors'])){echo "value=".$_POST['num_of_floors'];}?>>
