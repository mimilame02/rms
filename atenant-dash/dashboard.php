<?php
  require_once '../includes/dbconfig.php';
    ...
    */
    ...
    $result = mysqli_query($conn, "SELECT COUNT(*) as total FROM tickets WHERE status='Closed' OR status='Resolved'");
    $row = mysqli_fetch_assoc($result);
    ...
    $result = mysqli_query($conn, "SELECT SUM(total_due - amount_paid) AS total_balance FROM invoice WHERE status='Paid' AND MONTH(payment_date) = $current_month AND YEAR(payment_date) = $current_year AND tenant_id=$tenant_id");
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
            ...
            <div class="row">
                <div class="col-md-5 order-md-2 grid-margin transparent d-flex">
                  <div class="row flex-row">
                    <div class="col-md-5 mb-4 stretch-card transparent">
                      <div class="card card-dark-blue">
                        <div class="card-body white-text">
                          <span class="bx bx-comment-error icons d-flex flex-row flex-wrap justify-content-between align-items-center mx-auto"><p class="fs-45 mb-2 ff fs-35 pl-5 fw-bolder"><?php echo $totalPendingTickets; ?></p></span>
                    ...
                    <div class="col-md-5 mb-4 stretch-card transparent">
                      <div class="card card-dark-blue">
                        <div class="card-body white-text">
                          <span class="bx bx-comment-check icons d-flex flex-row flex-wrap justify-content-between align-items-center mx-auto"><p class="fs-45 mb-2 ff fs-35 pl-5 fw-bolder"><?php echo $totalClosedTickets; ?></p></span>
                        ...
                        <div class="card-body white-text mb-0" itemscope itemtype="https://schema.org/FinancialProduct">
                          <meta itemprop="name" content="Total Balance for <?php echo $_SESSION['current_month_name']; ?>">
                            <h2 class="fw-bolder mx-2" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                              <span class="bx bx-wallet icons d-flex flex-row flex-wrap justify-content-between align-items-center mx-auto"><p class="fs-45 mb-2 ff fs-35 pl-5 fw-bolder" itemprop="price" content="<?php echo $totalBalance; ?>"><span itemprop="priceCurrency" content="PHP">&#8369; <?php echo $totalBalance; ?></span>
                            </h2>
