                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="media align-items-center py-3 mb-3 w-100">
                                <img src="../img/userprofile/<?php echo $row['profile_img'] ?>" alt="" class="ml-2 px-2 rounded-circle" width="160" height="130">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="name" type="text"  value="<?php echo $row['first_name'] . " " . $row['middle_name'] . " " . $row['last_name'] ; ?>" readonly>
                                </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                        <input class="form-control" id="petd" value="<?php echo $pet_details; ?>"readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="vehicled">Vehicle Details</label>
                                        <input class="form-control" id="vehicled"  value="<?php echo implode(", ", json_decode($row['has_vehicle'])) . " " . $row['vehicle_specification']; ?>"readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
