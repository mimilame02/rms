...
class Tenant{
  ...
  public $status;
    ...
    function add() {
        $sql = "INSERT INTO tenants ( first_name, last_name, email, contact_no, relationship_status, type_of_household, previous_address, city, province, zip_code, sex, date_of_birth, has_pet, number_of_pets, type_of_pet, is_smoking, has_vehicle, vehicle_specification, occupants, co_applicant_first_name, co_applicant_last_name, co_applicant_email, co_applicant_contact_no, emergency_contact_person, emergency_contact_number, status) 
