...
class Properties{
    ...
    function properties_add() {
        ...
        $sql = "INSERT INTO properties (property_name,  property_description, num_of_floors, landlord_id, region, provinces, city, barangay, street, features_description, features, image_path, floor_plan) 
        VALUES (:property_name, :property_description, :num_of_floors, :landlord_id, :region, :provinces, :city, :barangay, :street, :features_description, :features, :image_path, :floor_plan)";
    ...
    function properties_edit() {
        // attempt insert query execution
        $sql = "UPDATE properties SET property_name=:property_name, property_description=:property_description, num_of_floors=:num_of_floors, landlord_id=:landlord_id, region=:region, provinces=:provinces, city=:city, barangay=:barangay, street=:street, features_description=:features_description, features=:features, image_path=:image_path, floor_plan=:floor_plan, updated_at=CURRENT_TIMESTAMP() WHERE id=:id;";
