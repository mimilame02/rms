...
class Invoice{
    ...
    function invoice_add() {
        $sql = "INSERT INTO invoice (lease_unit_id, tenant_id, monthly_rent, rent_due_date, electricity, water, penalty_id, rent_paid, balance) 
        VALUES (:lease_unit_id, :tenant_id, :monthly_rent, :rent_due_date, :electricity, :water, :penalty_id, :rent_paid, :balance)";        
        $query = $this->db->connect()->prepare($sql);
