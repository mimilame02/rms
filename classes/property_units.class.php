...
class Property_Units {
    ...
    function property_unit_add() {
        ...
        $sql = "INSERT INTO property_units (property_id, unit_type_id, unit_no, floor_level, num_rooms, num_bathrooms, monthly_rent, unit_condition_id, pu_features, status, one_month_deposit, one_month_advance) 
        VALUES (:property_id, :unit_type_id, :unit_no, :floor_level, :num_rooms, :num_bathrooms, :monthly_rent, :unit_condition_id, :pu_features, :status, :one_month_deposit, :one_month_advance)";
