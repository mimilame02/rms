                        ...
                        <div class="form-group-row w-100">
                          <div class="col">
                            ...
                            <div class="image-container float-right" style="display: none;">
                              <img id="uploaded-image" src="default-image.jpg" alt="Default Image" height="150px" width="150px">
                            </div>
                    ...
                    $('#identification_document').on('change', function() {
                      ...
                      if (input.files && input.files[0]) {
                        ...
                        reader.onload = function(e) {
                          ...
                          $('#identification_document').addClass('col-md-7');
                        ...
                        $('#identification_document').removeClass('col-md-7');
