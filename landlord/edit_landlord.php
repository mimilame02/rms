                      ...
                      <div class="col-md-6">
                        <div class="form-group-row w-100">
                          <div class="col">
                            ...
                            <input class="form-control form-control-sm col-sm-7" type="file" id="identification_document" name="identification_document" value="<?php echo $landlord_obj->identification_document ?>">
