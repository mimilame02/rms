                      ...
                      <div class="col-md-6">
                        <div class="form-group-row w-100">
                          <div class="col">
                            ...
                            <img id="uploaded-image" src="../img/<?php echo $landlord_obj->identification_document ?>" height="100px" width="100px">
                            <input class="form-control form-control-sm" type="file" id="identification_document" name="identification_document">
                          </div>
                        </div>
                      </div>
                    </div>
