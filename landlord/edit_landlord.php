  ...
  require_once '../classes/landlords.class.php';
    ...
    */
    ...
    if(isset($_POST['save'])){
      ...
      $landlord_obj->id = htmlentities($_POST['landlord-id']);
      ...
      if (isset($_FILES['identification_document']) && $_FILES['identification_document']['error'] === UPLOAD_ERR_OK && $_FILES['identification_document']['size'] > 0) {
        // User has uploaded a new non-empty file
    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="row">
            ...
            <form action="edit_landlord.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row g-3">
                      ...
                      <option value="None" <?php if(isset($_POST['provinces'])) { if ($_POST['provinces'] == 'None') echo ' selected="selected"'; } elseif ($landlord_obj->provinces == 'None') echo ' selected="selected"'; ?>>--Select--</option>
                      <?php
                              require_once '../classes/reference.class.php';
                              $ref_obj = new Reference();
                      ...
                      <option value="None" <?php if(isset($_POST['city'])) { if ($_POST['city'] == 'None') echo ' selected="selected"'; } elseif ($landlord_obj->city == 'None') echo ' selected="selected"'; ?>>--Select--</option>
                      <?php
                          require_once '../classes/reference.class.php';
                          $ref_obj = new Reference();
                        ...
                        <div class="form-group-row w-100">
                          <div class="col">
                            ...
                            <div class="image-container float-right">
                              <img id="uploaded-image" src="../img/<?php echo $landlord_obj->identification_document ?>" height="150px" width="150px">
                            </div>
                            <input class="form-control form-control-sm col-sm-6" type="file" id="identification_document" name="identification_document" value="<?php echo $landlord_obj->identification_document ?>">
                            <p class="mt-2">File name: <?php echo basename($landlord_obj->identification_document); ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <script>
                  $('#region').on('change', function(){
                        ...
                        const input = document.getElementById('identification_document');
