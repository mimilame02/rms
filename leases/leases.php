...
<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="card">
        ...
        <tbody>
        <?php
          $sql="SELECT lease.*, un.unit_no, ut.unit_type_id, pu.monthly_rent, tenant.first_name, tenant.last_name 
          FROM lease
          LEFT JOIN unit_no un ON lease.unit_no = un.unit_no
          LEFT JOIN unit_type ut ON lease.unit_type_id = ut.id 
          LEFT JOIN property_units pu ON lease.property_unit_id = pu.id
          LEFT JOIN tenant ON lease.tenant_id = tenant.id ";
