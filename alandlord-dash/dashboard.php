<?php
  require_once '../includes/dbconfig.php';
    ...
    */
    ...
    // Count total tickets
    $result = mysqli_query($conn, "SELECT COUNT(*) as total FROM tickets");
    $row = mysqli_fetch_assoc($result);
...
<div class="loading-screen">
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      <?php
          require_once 'landlord_sidebar.php';
        ?>
                  ...
                  <div class="row flex-row">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="card card-dark-blue">
                        <div class="card-body white-text">
                          <span class="bx bx-comment-error icons d-flex flex-row flex-wrap justify-content-between align-items-center mx-auto"><p class="fs-45 mb-2 ff fs-35 pl-5 fw-bolder"><?php echo $totalTickets; ?></p></span>
                          <p class="mb-1 pt-3 fw-bolder">Total Tickets </p>
                        </div>
                      </div>
                    </div>
