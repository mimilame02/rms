      ...
      <form action="save_user.php" method="POST">
        <div class="modal-body">
          <div class="col">
            ...
            <input  class="form-control form-control-sm " placeholder="Username" type="text" id="username" name="username" autocomplete="off">
            <br>
          </div>
          <div class="col">
...
<div class="modal fade" id="delmanage_userModal" tabindex="-1" aria-labelledby="delmanage_userModal_Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="delmanage_userModal_Label">Delete Hotel Rooms</h1>
